  ...
  return (
    <footer className="w-full bg-[#1A1A1A] pt-20 pb-10 px-6 md:px-12 -mt-12 relative z-0">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-12">
        ...
        {/* COLUMN 4: CONNECT */}
        <div className="space-y-4">
          <h4 className="text-[#C6A87C] text-xs font-bold uppercase tracking-widest">Connect</h4>
          <div className="flex gap-4">
            {/* LinkedIn Icon */}
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-[#C6A87C] hover:text-white transition-all">
